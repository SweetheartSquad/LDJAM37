function Menu(_players){
	...
	this.playerGraphics[1].x = size.x * 0.75;
	this.playerGraphics[1].y = size.y * 0.3;

	this.playerGraphics[2].x = size.x * 0.25;
	this.playerGraphics[2].y = size.y * 0.7;
